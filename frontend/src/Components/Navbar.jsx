          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                ...
                <span className="absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-2 py-0.5 text-xs group-hover:bg-emerald-400 transition duration-300 ease-in-out          {cart.length}">
                  3
                </span>
              </Link>
            )}
